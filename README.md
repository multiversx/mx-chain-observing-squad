...
```bash
cd mainnet
docker image build . -t multiversx/chain-observer:v1.8.7.0 -f ./chain-observer
docker image build . -t multiversx/chain-squad-proxy:v1.1.55 -f ./chain-proxy
```
...
```bash
docker pull multiversx/chain-observer:v1.8.7.0
docker pull multiversx/chain-squad-proxy:v1.1.55
