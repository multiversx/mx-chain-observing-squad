...
```bash
cd mainnet
docker image build . -t multiversx/chain-observer:v1.5.12.0 -f ./chain-observer
docker image build . -t multiversx/chain-squad-proxy:v1.1.39 -f ./chain-proxy
```
...
```bash
docker pull multiversx/chain-observer:v1.5.12.0
