...
```bash
cd mainnet
docker image build . -t elrondnetwork/elrond-node-obs:v1.1.59 -f ./elrond-node-obs
docker image build . -t elrondnetwork/elrond-proxy:v1.1.12 -f ./elrond-proxy
```
...
```bash
docker pull elrondnetwork/elrond-node-obs:v1.1.59
docker pull elrondnetwork/elrond-proxy:v1.1.12
