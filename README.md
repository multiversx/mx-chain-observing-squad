...
```bash
cd mainnet
docker image build . -t multiversx/chain-observer:v1.10.4.0 -f ./chain-observer
docker image build . -t multiversx/chain-squad-proxy:v1.3.0 -f ./chain-proxy
```
...
```bash
docker pull multiversx/chain-observer:v1.10.4.0
docker pull multiversx/chain-squad-proxy:v1.3.0
