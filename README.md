...
```bash
cd mainnet
docker image build . -t elrondnetwork/elrond-node-obs:v1.1.37 -f ./elrond-node-obs
docker image build . -t elrondnetwork/elrond-proxy:v1.1.9 -f ./elrond-proxy
```
...
```bash
docker pull elrondnetwork/elrond-node-obs:v1.1.37
docker pull elrondnetwork/elrond-proxy:v1.1.9
