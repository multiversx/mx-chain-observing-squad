...
```bash
cd mainnet
docker image build . -t multiversx/chain-observer:v2.0.5.0-rc1 -f ./chain-observer
docker image build . -t multiversx/chain-squad-proxy:v1.5.1 -f ./chain-proxy
```
...
```bash
docker pull multiversx/chain-observer:v2.0.5.0-rc1
docker pull multiversx/chain-squad-proxy:v1.5.1
