...
```bash
cd mainnet
docker image build . -t multiversx/chain-observer:v1.4.14.0 -f ./chain-observer
docker image build . -t multiversx/chain-squad-proxy:v1.1.34 -f ./chain-proxy
```
...
```bash
docker pull multiversx/chain-observer:v1.4.14.0
docker pull multiversx/chain-squad-proxy:v1.1.34
