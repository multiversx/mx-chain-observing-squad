...
```bash
cd mainnet
docker image build . -t elrondnetwork/elrond-node-obs:v1.3.44 -f ./elrond-node-obs
docker image build . -t elrondnetwork/elrond-proxy:v1.1.25 -f ./elrond-proxy
```
...
```bash
docker pull elrondnetwork/elrond-node-obs:v1.3.44
docker pull elrondnetwork/elrond-proxy:v1.1.25
