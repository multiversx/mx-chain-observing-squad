...
```bash
cd mainnet
docker image build . -t multiversx/chain-observer:v1.10.8.0 -f ./chain-observer
docker image build . -t multiversx/chain-squad-proxy:v1.3.3 -f ./chain-proxy
```
...
```bash
docker pull multiversx/chain-observer:v1.10.8.0
docker pull multiversx/chain-squad-proxy:v1.3.3
